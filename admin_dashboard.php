...
<body>
    <div class="sidebar">
        ...
        <a href="admin_dashboard.php" class="nav-item active"><i class="material-icons">dashboard</i> Content Manager</a>
        <a href="admin_settings.php" class="nav-item"><i class="material-icons">settings</i> Settings</a>
